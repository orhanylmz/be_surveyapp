...
@Entity
@Table(name = "survey_question", uniqueConstraints = { @UniqueConstraint(columnNames = { "fk_survey_id", "sequence" }) })
public class QuestionEntity extends BaseEntity {
	@Id
	@SequenceGenerator(name = "survey_question_id_seq", allocationSize = 1)
